  ...
  <form>
    ...
    <div class="form-check">
      ...
      <label class="form-check-label flex" id="switch" for="inlineCheckbox0">
        <img class="img-switch no_active" id="switch-off" src="<?php echo get_template_directory_uri();?>/img/switch-off.png" alt="img">
    ...
    <div class="form-line">
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label1" for="inlineCheckbox1">
          <img class="img-radio no_active off" id="radio-off-1" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-1" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Пол
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label2" for="inlineCheckbox2">
          <img class="img-radio no_active off" id="radio-off-2" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-2" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Капот
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label3" for="inlineCheckbox3">
          <img class="img-radio no_active off" id="radio-off-3" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-3" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Двери
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label4" for="inlineCheckbox4">
          <img class="img-radio no_active off" id="radio-off-4" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-4" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Багажник
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label5" for="inlineCheckbox5">
          <img class="img-radio no_active off" id="radio-off-5" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-5" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Крышка багажника
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label6" for="inlineCheckbox6">
          <img class="img-radio no_active off" id="radio-off-6" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio on" id="radio-on-6" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Крыша
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label7" for="inlineCheckbox7">
          <img class="img-radio off" id="radio-off-7" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio no_active on" id="radio-on-7" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Передняя панель
        </label>
      </div>
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" id="label8" for="inlineCheckbox8">
          <img class="img-radio off" id="radio-off-8" src="<?php echo get_template_directory_uri();?>/img/radio-off.png" alt="radio">
          <img class="img-radio no_active on" id="radio-on-8" src="<?php echo get_template_directory_uri();?>/img/radio-on.png" alt="radio">
          Арки
        </label>
      </div>
    </div>
